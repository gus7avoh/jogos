...
def ParImpar():
            ...
            if tabela in ["s", "ss", "sim"]:
                ...
                print("="*20)
                menu.cabeçalho("Obrigado por jogar par ou impar")
...
def AdvUmNumero():
            smart.limpar_terminal()
            menu.cabeçalho("adivinhe um numero")
            cont_v = 0
            cont_d = 0            
            while True:                
            ...
            if tabela in ["s", "ss", "sim"]:
                ...
                print("="*20)
                menu.cabeçalho("Obrigado por jogar acerte o numero!!!!")
                pergunta = str(input("Quer jogar outro jogo? "))
                if pergunta in ["s", "ss", "sim"]:
                    new = False
                elif pergunta not in ["s", "ss", "sim"]:
...
def PPt():
    smart.limpar_terminal()
    menu.cabeçalho("pedra papel e tesoura")
    contador = 0
    vi = 0
    de = 0
    enpa = 0     
    ...
    if tabela in ["s", "ss", "sim"]:
        ...
        print("="*50)
        menu.cabeçalho("Obrigado por jogar pedra papel e tesoura!!!")
        pergunta = str(input("Quer jogar outro jogo? "))
        if pergunta in ["s", "ss", "sim"]:
            new = False
        elif pergunta not in ["s", "ss", "sim"]:
